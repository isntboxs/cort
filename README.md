...
CodeRabbit is repository tooling, not app runtime code. Install the CodeRabbit GitHub App for this repository from CodeRabbit/GitHub, then it will read `.coderabbit.yaml` from the repository root for pull request reviews.
